...
public class Cat {
	...
	// change head to be twice as big
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		x = catX + EYE_X; 
		y = catY + EYE_Y;
		g2.fillOval(x, y, EYE_WIDTH, EYE_HEIGHT - 10);
		x += EYE_SEPARATION;
		g2.fillOval(x, y, EYE_WIDTH, EYE_HEIGHT);
		// Draw the mouth
		// change color of eyes to cyan
		...
		g2.drawString("Puurrrr", catX, catY+HEAD_DIMENSION+10);	
	}
}
